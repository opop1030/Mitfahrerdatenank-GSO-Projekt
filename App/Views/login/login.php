    ...
    <div class="col-md-6">
        ...
        <form id="login" action="login_action.php" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" name="inputBenutzer" placeholder="Email">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-4"><label for="inputPassword" class="col-sm-2 col-form-label">Passwort</label></div>
                <div class="col-sm-8">
                <input type="password" class="form-control" name="inputPassword" placeholder="Passwort">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
    ...
    <div class="col-md-6">
        ...
        <form id="register" action="register_action.php" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="password" class="form-control" name="inputPassword2" placeholder="Passwort wiederholen">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" name="inputNachname" placeholder="Nachname">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control" name="inputPostleitzahl" placeholder="Postleitzahl">
                </div>
            </div>
